...
def parse_args():
    ...
    parser.add_argument('--config', default='/workspace/workspace/pose/mmpose/configs_xz/face/2d_kpt_sview_rgb_img/topdown_heatmap/wflw/xz_mobilenetv2_wflw_256x256 copy.py')
    parser.add_argument('--checkpoint', default='/workspace/workspace/pose/results/faceWFLF/epoch_30.pth')
    parser.add_argument('--show', action='store_true', help='show onnx graph')
    parser.add_argument('--output-file', type=str, default='test_tmp_hand.onnx')
