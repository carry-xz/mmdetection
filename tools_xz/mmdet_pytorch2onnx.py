...
def parse_args():
    ...
    parser.add_argument('-config', default='/workspace/workspace/detection/mmdetection/work_dirs/xz_gfl_mobile_fpn_mstrain_2x_face_hand_fp32/xz_gfl_mobile_fpn_mstrain_2x_face_hand_32.py')
    parser.add_argument('-checkpoint', default='/workspace/workspace/detection/mmdetection/work_dirs/xz_gfl_mobile_fpn_mstrain_2x_face_hand_fp32/epoch_1.pth')
    # parser.add_argument('-config', default='/workspace/workspace/detection/mmdetection/configs_shawn/gfl/xz_gfl_mobile_fpn_mstrain_2x_face_hand.py')
    # parser.add_argument('-checkpoint', default='/workspace/workspace/detection/mmdetection/work_dirs/xz_gfl_mobile_fpn_mstrain_2x_face_hand/epoch_24.pth')
    parser.add_argument('--input-img', type=str, default='/workspace/workspace/detection/mmdetection/demo/demo.jpg')
    parser.add_argument(
        '--show',
        action='store_true',
        help='Show onnx graph and detection outputs')
    parser.add_argument('--output-file', type=str, default='./tmp_fp32.onnx')
    parser.add_argument('--opset-version', type=int, default=11)
    parser.add_argument(
        '--test-img', type=str, default='/workspace/workspace/detection/mmdetection/demo/demo.jpg')
    parser.add_argument(
